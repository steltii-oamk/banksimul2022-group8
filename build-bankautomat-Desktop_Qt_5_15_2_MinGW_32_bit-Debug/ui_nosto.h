...
public:
    ...
    void setupUi(QDialog *Nosto)
    {
        ...
        verticalLayout_2->addWidget(lNosto);

        checkBox = new QCheckBox(Nosto);
    ...
    void retranslateUi(QDialog *Nosto)
    {
        ...
        checkBox->setText(QCoreApplication::translate("Nosto", "CheckBox", nullptr));
        ...
        nClose->setText(QCoreApplication::translate("Nosto", "Takaisin", nullptr));
    } // retranslateUi
